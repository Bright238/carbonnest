...
export const TrendingCollection: React.FC<TrendingActivity> = ({ title, owner, usd_value, image, avatar }) => {
  ...
  return (
    <S.Card padding={0} $img={image}>
      <S.CollectionImage
        src="https://media.istockphoto.com/id/543185364/photo/young-african-male-and-adult-african-woman-working-in-garden.jpg?s=2048x2048&w=is&k=20&c=Q9xITl02yzDAFEgyYrIe_6LQx-o01ghN6ERXnDjJdEw="
        alt="nft"
      />
