...
import { Step1 } from './CDASteps/Step1';
import { Step2 } from './CDASteps/Step2';
import { Step3 } from './CDASteps/Step3';
import { Step4 } from './CDASteps/Step4';
import { Step5 } from './CDASteps/Step5';
import { Step6 } from './CDASteps/Step6';
import { Step9 } from './CDASteps/Step9';
const apiUrl = `${process.env.REACT_APP_BASE_URL}/items`;
const collectionName = 'cda_supervision_and_mentorship';

export const CDAMentorshipStepForm = () => {
...
export default CDAMentorshipStepForm;
