...
export const ProcurementStepForm = () => {
  ...
  const [fields, setFields] = useState([
    ...
    {
      name: 'procurementGuidelinesQ1b',
      value: 'Q1.b Has the officer in charge of procurement read and understood the Act?',
    },
    ...
    {
      name: 'procurementGuidelinesQ2b',
      value: 'Q2.b Has the officer in charge of procurement read and understood the regulations?',
    },
    ...
    {
      name: 'procurementStaffStaffQ2',
      value: 'Q2. Are staff conducting procurement work members of the Zambia Institute of Purchasing & Supply?',
    },
    ...
    {
      name: 'procurementPlanningQ4',
      value: '4: Is the procurement plan revised to include additional approved procurements?',
    },
    ...
    {
      name: 'processProcurementQ2',
      value: 'Q2. Are Purchase Requisitions from the users approved by departmental head?',
    },
    ...
    {
      name: 'processProcurementQ7',
      value: 'Q7. Do Purchase Orders contain the terms and conditions for the procurement?',
    },
    ...
    {
      name: 'pricingMarketPriceIndexQ1Q',
      value: 'Q1. Are goods and services procured with reference to the Market Price Index (MPI)?',
    },
    { name: 'pricingMarketPriceIndexQ1Response', value: '' },
    { name: 'markertPricingIndexCommentQ1', value: '' },

    {
      name: 'pricingMarketPriceIndexQ2Q',
      value: 'Q2. Is price reasonableness analysis undertaken for items not covered in the MPI?',
    },
