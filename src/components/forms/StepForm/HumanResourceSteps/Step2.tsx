  ...
  return (
    <S.FormContent>
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 1: Code of Ethics/ National Values
        </Typography.Title>
        <HighlightedQuestion>
          Question 1.a: Does every public service employee at the district have the code of ethics?
        </HighlightedQuestion>
        <Typography>
          Indicator: Availability of copies of code of ethics on file
        </Typography>
        <Typography>
          Source of Information/Means of Verification: staff files
        </Typography>
      </Dragger>
      ...
      <Dragger>
        ...
        <Typography>
          Indicator: Availability of copies of code of ethics
        </Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard 2: Public Service Terms and Conditions of service
        </Typography.Title>
        <HighlightedQuestion>
          Question 2.a: Does every public service employee at the district have terms and conditions of service?
        </HighlightedQuestion>
        <Typography>
          Indicator: Availability of copies of code of the terms of conditions of service
        </Typography>
        <Typography>
          Source of Information/Means of Verification: copies of Public Service and Conditions of Service on file or booklet
        </Typography>
      </Dragger>
      <Form.Item
        rules={[{ required: true, message: t('This is a required field!') }]}
      ...
      <Dragger>
        ...
        <Typography>
          Indicator: Knowledge of the Public Service Terms and Conditions of service document
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Question 3.a: Does every public service employee at the district have the Disciplinary Code and Procedures for handling Offenses in Public Service?
        </HighlightedQuestion>
        <Typography>
          Indicator: Availability of copies of Disciplinary code and procedures for handling cases in public service
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Copy of Disciplinary code and procedures for handling offenses in public service on file or booklet
        </Typography>
      </Dragger>
      <Form.Item
        rules={[{ required: true, message: t('This is a required field!') }]}
      ...
      <Dragger>
        <HighlightedQuestion>
          Question 3.b: Have all the officers read or been oriented and understood the Disciplinary Code and Procedures for handling Offenses in Public Service?
        </HighlightedQuestion>
        <Typography>
          Indicator: Knowledge of the Public Service Terms and Conditions of service document
        </Typography>
      ...
      <Dragger>
        ...
        <Typography>
          Indicator: Availability of copies of the SWAZ Act No. 4 of 2022
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Copy of the SWAZ Act. No. 4 of 2022
        </Typography>
      </Dragger>
      <Form.Item
        rules={[{ required: true, message: t('This is a required field!') }]}
      ...
      <Dragger>
        ...
        <Typography>
          Indicator: Knowledge of the SWAZ Act. No. 4 of 2022
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Test question from the document
        </Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard 7: Training policy
        </Typography.Title>
        <HighlightedQuestion>
          Question 7.a: Is there a copy of the training policy at the office?
        </HighlightedQuestion>
        <Typography>
          Indicator: Training Policy
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Physical check
        </Typography>
      ...
      <Dragger>
        ...
        <Typography>
          Indicator: Knowledge of the training policy
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Test question from the document
        </Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard 8: Social Workers code of Ethics
        </Typography.Title>
        <HighlightedQuestion>
      ...
      <Dragger>
        ...
        <Typography>
          Indicator: Availability of copies of signed code of ethics
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Test question from the document
        </Typography>
