...
export const FinanceStepForm = () => {
  ...
  const [fields, setFields] = useState([
    ...
    {
      name: 'depositCash48HoursNoDeduct',
      value: 'Does the office deposit all cash received within 48 hours without deducting 10%?',
    },
    { name: 'depositCash48HoursNoDeductResponse', value: '' },
    { name: 'depositCash48HoursNoDeductComment', value: '' },

    {
      name: 'redepositJournals',
      value: 'Does the office create redeposit journals in Microsoft Dynamics 365 when funds are received?',
    },
    ...
    {
      name: 'paymentVouchersSequentiallyFiled',
      value: 'Are payment vouchers sequentially filed with reference to cheque numbers and date?',
    },
    ...
    {
      name: 'paymentVouchersSupportingDocuments',
      value: 'Do payment vouchers have all relevant supporting documents?',
    },
    ...
    {
      name: 'bankReconciliationsSigned',
      value: 'Are all the Bank reconciliation statements signed by the District officer?',
    },
    ...
    {
      name: 'signatoriesSegregated',
      value: 'Are the signatories segregated into Accounting and non-accounting staff?',
    },
    ...
    {
      name: 'officerAccountableDocuments',
      value: 'Is there an officer appointed to look after all accountable documents?',
    },
    ...
    {
      name: 'districtQuarterlyMonitoring',
      value: 'Has the district been conducting quarterly monitoring of PPMs, CWACs, and beneficiaries?',
    },
    { name: 'districtQuarterlyMonitoringResponse', value: '' },
    { name: 'districtQuarterlyMonitoringComment', value: '' },

    {
      name: 'districtQuarterlyMonitoringProvince',
      value: 'Has the District been monitored by the Province quarterly this year?',
    },
    { name: 'districtQuarterlyMonitoringProvinceResponse', value: '' },
    { name: 'districtQuarterlyMonitoringProvinceComment', value: '' },

    {
      name: 'qualityAssuranceScaleUpActivities',
      value: 'Was quality assurance conducted on all scale-up activities and community trainings?',
    },
  ...
  const steps = [
    { title: t('Biochar Training Information') },
    // { title: t('Guidelines') },
    // { title: t('Receipts') },
    // { title: t('Budgets') },
    // { title: t('Payments') },
