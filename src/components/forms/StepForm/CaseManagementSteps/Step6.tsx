...
export const Step6: React.FC<Step6Props> = ({ handleChange }) => {
  ...
  return (
    <S.FormContent>
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 1: Service Directory and Utilization</Typography.Title>

        <HighlightedQuestion>
          Question 1.i: Does your district have a service directory? Probe: When was it last updated?
        </HighlightedQuestion>
        <Typography>Indicator: Existence and update status of the service directory</Typography>
        <Typography>Source of Information/Means of Verification: Review service directory records</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 2: Coordination Meetings and Case Management</Typography.Title>

        <HighlightedQuestion>
          Question 1.ii: Is your district using the service directory for coordination and bi-directional referral?
          Probe: used at both district and sub-center level?
        </HighlightedQuestion>
        <Typography>Indicator: Utilization of the service directory for coordination and referrals</Typography>
        <Typography>Source of Information/Means of Verification: Review coordination and referral processes</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 3: Meetings and Case Conferences</Typography.Title>

        <HighlightedQuestion>
          Question 2.i: Were coordination meetings held by your district? (Probe: Should be held at least once per
          quarter)
        </HighlightedQuestion>
        <Typography>Indicator: Frequency and documentation of coordination meetings</Typography>
        <Typography>Source of Information/Means of Verification: Meeting minutes and records</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 4: Case Conferences and Reviews</Typography.Title>

        <HighlightedQuestion>Question 2.ii: Were case conferences conducted for complex cases?</HighlightedQuestion>
        <Typography>Indicator: Frequency and documentation of case conferences for complex cases</Typography>
        <Typography>Source of Information/Means of Verification: Case conference records and reports</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 5: Stakeholder Coordination</Typography.Title>

        <HighlightedQuestion>
          Question 2.iii: Were case reviews/BID panels held jointly with partners including CCFs, relevant institutions
          and NGO service providers?
        </HighlightedQuestion>
        <Typography>Indicator: Coordination of case reviews/BID panels with stakeholders</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 6: Coordination Structure and Workplan</Typography.Title>

        <HighlightedQuestion>
          Question 2.iv: Were case conferences conducted by stakeholders successful? (Probe for challenges that were
          faced, if any)
        </HighlightedQuestion>
        <Typography>Indicator: Success and challenges of case conferences</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 7: District-Level Coordination Structure</Typography.Title>

        <HighlightedQuestion>
          Question 2.v: Is there a selected district-level coordination structure used for implementation of VCA
          community case management?
        </HighlightedQuestion>
        <Typography>Indicator: Existence and use of district-level coordination structure</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Coordination and Referral</Typography.Title>
        <Typography.Title level={4}>Standard 8: Workplan for Coordination Structure</Typography.Title>

        <HighlightedQuestion>
          Question 2.vi: Is there a district workplan (with clear milestones) for the district-level coordination
          structure?
        </HighlightedQuestion>
        <Typography>Indicator: Existence and clarity of district workplan for coordination structure</Typography>
        <Typography>Source of Information/Means of Verification: Review of district workplan</Typography>
      </Dragger>
