  ...
  return (
    <S.FormContent>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 1: Supervision and Mentorship Practices
        </Typography.Title>

        <HighlightedQuestion>
          Question 1.i: Have you been supervising and mentoring CDAs using the standardized supervision and mentorship tool?
        </HighlightedQuestion>
        <Typography>
          Indicator: Use of standardized tools for supervising and mentoring CDAs
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Review supervision and mentorship records
        </Typography>
      </Dragger>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 2: Case Management Plans
        </Typography.Title>
        ...
        <Typography>
          Indicator: Adherence to case management supervision and mentorship plans
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 3: Supervision of CWACs
        </Typography.Title>

        <HighlightedQuestion>
          Question 1.iii: Have CDAs been supervising and mentoring CWACs using the standardized supervision and mentorship tool?
        </HighlightedQuestion>
        <Typography>
          Indicator: Use of standardized tools by CDAs to supervise and mentor CWACs
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 4: Case Management Plans for CDAs
        </Typography.Title>
        ...
        <Typography>
          Indicator: Adherence of CDAs to supervision and mentorship plans
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 5: Workplans and Budgets for Case Management
        </Typography.Title>
        ...
        <Typography>
          Indicator: Availability of workplan and budget for statutory case management
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 6: Budget Approval and Resource Disbursement
        </Typography.Title>

        <HighlightedQuestion>
          Question 2.ii: Was the budget approved for statutory case management?
        </HighlightedQuestion>
        <Typography>
          Indicator: Approval of budget for statutory case management
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Review budget approval records
        </Typography>
      </Dragger>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 7: Resource Management
        </Typography.Title>
        ...
        <Typography>
          Indicator: Disbursement of resources for statutory case management
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Review records of resource disbursement
        </Typography>
      </Dragger>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 8: Workplans and Budgets for Community Case Management
        </Typography.Title>
        ...
        <Typography>
          Indicator: Availability of workplan and budget for community case management
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 9: Resource Management for Community Case Management
        </Typography.Title>

        <HighlightedQuestion>
          Question 2.v: Was the budget approved for community case management?
        </HighlightedQuestion>
        <Typography>
          Indicator: Approval of budget for community case management
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Review budget approval records
        </Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 10: Resource Disbursement for Community Case Management
        </Typography.Title>
        ...
        <Typography>
          Indicator: Disbursement of resources for community case management
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Review records of resource disbursement
        </Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 11: Availability of Materials
        </Typography.Title>

        <HighlightedQuestion>
          Question 2.vii: Do your CDAs have access to materials for implementation of case management? i.e.• Tablet• Data Bundles• Bicycles• CCM Forms• Boots• Raincoats• Umbrella• T-shirt• ID• PPEs
        </HighlightedQuestion>
        <Typography>
          Indicator: Availability of materials for CDAs
        </Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <Typography.Title level={4}>
          Standard 12: Access to Materials for CWACs
        </Typography.Title>

        <HighlightedQuestion>
          Question 2.viii: Do your CWACs have access to materials for implementation of case management? i.e. CM-Forms, ID, Phone and airtime
        </HighlightedQuestion>
        <Typography>
          Indicator: Availability of materials for CWACs
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Check availability and provision of materials
        </Typography>
