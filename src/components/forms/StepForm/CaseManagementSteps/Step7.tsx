...
export const Step7: React.FC<Step7Props> = ({ handleChange }) => {
  ...
  return (
    <S.FormContent>
      <Dragger>
        <Typography.Title level={4}>Data Management</Typography.Title>
        <Typography.Title level={4}>Standard 1: Case Management Information System</Typography.Title>

        <HighlightedQuestion>Question 1.i: Is there Case Management Information System in place?</HighlightedQuestion>
        <Typography>Indicator: Presence of Case Management Information System</Typography>
        <Typography>Source of Information/Means of Verification: Review system implementation</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Data Management</Typography.Title>
        <Typography.Title level={4}>Standard 2: Access and Use of Data</Typography.Title>

        <HighlightedQuestion>
          Question 1.ii: Do you have access to an updated Case Management Information System?
        </HighlightedQuestion>
        <Typography>Indicator: Access to and currency of Case Management Information System</Typography>
        <Typography>Source of Information/Means of Verification: Check access and updates to the system</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Data Management</Typography.Title>
        <Typography.Title level={4}>Standard 3: Utilization of Data</Typography.Title>

        <HighlightedQuestion>
          Question 1.iii: Is data from the Case management information system being used for decision making and service
          provision?
        </HighlightedQuestion>
        <Typography>Indicator: Use of data for decision making and service provision</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Data Management</Typography.Title>
        <Typography.Title level={4}>Standard 4: Training and Implementation Strategy</Typography.Title>

        <HighlightedQuestion>
          Question 2.i: Have you been trained in the use of Case Management Information System?
        </HighlightedQuestion>
        <Typography>Indicator: Training in Case Management Information System</Typography>
        <Typography>Source of Information/Means of Verification: Training records</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Data Management</Typography.Title>
        <Typography.Title level={4}>Standard 5: MIS Implementation Strategy</Typography.Title>

        <HighlightedQuestion>
          Question 2.ii: Are you using the Case management MIS in following a clear implementation strategy (including
          how to sustain it)?
        </HighlightedQuestion>
        <Typography>Indicator: Implementation strategy for Case Management Information System</Typography>
        <Typography>
