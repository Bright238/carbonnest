...
export const Step4: React.FC<Step4Props> = ({ handleChange }) => {
  ...
  return (
    <S.FormContent>
      <Dragger>
        <Typography.Title level={4}>Capacity and Knowledge</Typography.Title>
        <Typography.Title level={4}>Standard 1: Training and Certification</Typography.Title>

        <HighlightedQuestion>
          Question 1: Have case workers, supervisors, and managers been trained in the approved MCDSS guidelines and
          training materials by a recognized trainer? (Probe: When were the case workers last trained?)
        </HighlightedQuestion>
        <Typography>Indicator: Training and certification of case workers and supervisors</Typography>
        <Typography>Source of Information/Means of Verification: Review training records and certificates</Typography>
      </Dragger>
      ...
      >
        <NarrowPicker format="DD-MM-YYYY" onChange={(date: any) => handleChange('date', date)} />
      </NarrowFormItem>
      ...
      <Dragger>
        <Typography.Title level={4}>Capacity and Knowledge</Typography.Title>
        <Typography.Title level={4}>Standard 2: Application of Safeguarding Principles</Typography.Title>

        <HighlightedQuestion>
          Question 2.i: Do case workers meet the criteria as defined? (i.e trained in child safeguarding & signed Code
          of conduct)?
        </HighlightedQuestion>
        <Typography>Indicator: Compliance with safeguarding training and Code of conduct</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Capacity and Knowledge</Typography.Title>
        <Typography.Title level={4}>Standard 3: Child Safeguarding Training</Typography.Title>

        <HighlightedQuestion>
          Question 2.ii: Are all case workers applying child safeguarding principles (tailored to case management)?
        </HighlightedQuestion>
        <Typography>Indicator: Application of child safeguarding principles in case management</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Capacity and Knowledge</Typography.Title>
        <Typography.Title level={4}>Standard 4: Orientation on Child Safeguarding</Typography.Title>

        <HighlightedQuestion>
          Question 2.iii: Were all case workers oriented/trained on Child safeguarding?
        </HighlightedQuestion>
        <Typography>Indicator: Orientation and training on child safeguarding</Typography>
        <Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>Capacity and Knowledge</Typography.Title>
        <Typography.Title level={4}>Standard 5: Code of Conduct</Typography.Title>

        <HighlightedQuestion>
          Question 3: Have all case workers signed the code of conduct commitment form?
        </HighlightedQuestion>
        <Typography>Indicator: Signed Code of conduct commitment forms</Typography>
        <Typography>Source of Information/Means of Verification: Review signed Code of conduct forms</Typography>
      </Dragger>
      ...
      <Dragger>
        <Typography.Title level={4}>Capacity and Knowledge</Typography.Title>
        <Typography.Title level={4}>Standard 6: Compliance to Safeguarding Principles</Typography.Title>

        <HighlightedQuestion>
          Question 4: Are all case workers compliant to child safeguarding principles? (Probe: Are there any case
          workers reported for non-compliance?)
        </HighlightedQuestion>
        <Typography>Indicator: Number of case workers reported for non-compliance</Typography>
        <Typography>Source of Information/Means of Verification: District Report</Typography>
      </Dragger>
