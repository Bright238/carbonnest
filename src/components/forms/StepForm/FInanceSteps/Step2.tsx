    ...
    <S.FormContent>
      <Dragger>
        <Typography.Title level={4}>
          Standard: Public Finance Management Act 2018
        </Typography.Title>
        <HighlightedQuestion>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Have you read and understood the PFM Act 2018?
        </HighlightedQuestion>
        <Typography>
          Indicator: Evidence of comprehension or training on the Act
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Self-assessment or certificate of training
        </Typography>
      </Dragger>
      <Form.Item
        rules={[{ required: true, message: t('This is a required field!') }]}
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard: Public Finance Management Regulations 2020
        </Typography.Title>
        <HighlightedQuestion>
          Does the office have a copy of the PFM Regulations 2020?
        </HighlightedQuestion>
        <Typography>
          Indicator: Physical or Soft copy of the Regulations
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Check filed or saved copy
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Have you read and understood the PFM Regulations 2020?
        </HighlightedQuestion>
        <Typography>
          Indicator: Evidence of comprehension or training on the Regulations
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Self-assessment or certificate of training
        </Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard: SCT Guidelines
        </Typography.Title>
        <HighlightedQuestion>
          Does the Office have a copy of the SCT Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Physical or Soft copy of the Guidelines
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Check filed or saved copy
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Have you read and understood the SCT Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Evidence of comprehension or training on the Guidelines
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Self-assessment or certificate of training
        </Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard: PWAS Guidelines
        </Typography.Title>
        <HighlightedQuestion>
          Does the office have a copy of the PWAS Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Physical or Soft copy of the Guidelines
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Have you read and understood the PWAS Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Evidence of comprehension or training on the Guidelines
        </Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard: FSP Guidelines
        </Typography.Title>
        <HighlightedQuestion>
          Does the office have a copy of the FSP Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Physical or Soft copy of the Guidelines
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Have you read and understood the FSP Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Evidence of comprehension or training on the Guidelines
        </Typography>
      ...
      <Dragger>
        <Typography.Title level={4}>
          Standard: LESS Guidelines
        </Typography.Title>
        <HighlightedQuestion>
          Does the office have a copy of the LESS Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Physical or Soft copy of the Guidelines
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Have you read and understood the LESS Guidelines?
        </HighlightedQuestion>
        <Typography>
          Indicator: Evidence of comprehension or training on the Guidelines
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Does the Office have a Chart of Accounts?
        </HighlightedQuestion>
        <Typography>
          Indicator: Availability of the Chart of Accounts
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Check filed or saved copy
        </Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>
          Do you understand how to apply the codes?
        </HighlightedQuestion>
        <Typography>
          Indicator: Knowledge of code application
        </Typography>
        <Typography>
          Source of Information/Means of Verification: Self-assessment or training evidence
        </Typography>
      </Dragger>
      <Form.Item
        rules={[{ required: true, message: t('This is a required field!') }]}
