    ...
    <S.FormContent>
      <Dragger>
        <Typography.Title level={4}>
          Standard: Quarterly and Annual reports should be prepared and submitted by the 15th day following the end of
          the quarter.
        </Typography.Title>
        <HighlightedQuestion>Are quarterly reports available and submitted on time?</HighlightedQuestion>
        <Typography>Indicator: Availability of filed reports.</Typography>
        <Typography>
      ...
      <Dragger>
        ...
        <HighlightedQuestion>Are spot checks and monitoring reports filed?</HighlightedQuestion>
        <Typography>Indicator: Availability of filed reports.</Typography>
        <Typography>
          Source of Information/Means of Verification: Verify availability and status of the reports.
        </Typography>
